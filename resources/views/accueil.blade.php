...
@section('menu_nav')
    ...
    <li><a href="{{ route('accueil') }}" class="link-underline text-base">Accueil</a></li>
    <li><a href="{{ route('projets') }}" class="link-underline text-base">Mes projets</a></li>
    <li><a href="{{ route('competences') }}" class="link-underline text-base">Mes compétences</a></li>
    <li><a href="{{ route('experiences') }}" class="link-underline text-base">Mes expériences professionnelles</a></li>
    <li><a href="{{ route('parcours') }}" class="link-underline text-base">Mon parcours</a></li>
    <li><a href="{{ route('contact') }}" class="link-underline text-base">Contact</a></li>
...
<header class="flex flex-col
                ...
                overflow-hidden
                -z-10" oncontextmenu="return false"
                id="header">
...
<main class="flex flex-col
    ...
    <div class="flex flex-col
        ...
        <img class="absolute
                    ...
                    md:max-w-2xl
                    md:relative
                    md:rounded-lg" src="{{ asset('storage/image/accueil/fond_dev_web.png') }}">
    ...
    <div class="flex flex-col
        ...
        <img class="absolute
                    ...
                    md:max-w-2xl
                    md:relative
                    md:rounded-lg" src="{{ asset('storage/image/accueil/fond_dev_soft.png') }}">
    ...
    <div class="flex flex-col
        ...
        <img class="absolute
                    ...
                    md:max-w-2xl
                    md:relative
                    md:rounded-lg" src="{{ asset('storage/image/accueil/fond_gestion_projet.png') }}">
    ...
    <div class="flex flex-col
        ...
        <img class="absolute
                    ...
                    md:max-w-2xl
                    md:relative
                    md:rounded-lg" src="{{ asset('storage/image/accueil/fond_stream.png') }}">
    ...
    <img class="w-full md:max-w-md
                        ...
                        z-50
                        md:mb-10" src="{{ asset('storage/image/accueil/photo_profil.jpg') }}">
